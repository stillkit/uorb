...
public:
	 ...
	 */
	virtual int	poll(file_t *filep, pollfd_struct_t *fds, bool setup);
...
private:
	 ...
	 */
	int		store_poll_waiter(pollfd_struct_t *fds);
	 ...
	 * @return		OK, or -errno on error.
	 */
	int		remove_poll_waiter(pollfd_struct_t *fds);
